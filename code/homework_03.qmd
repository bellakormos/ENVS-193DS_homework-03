...
**Figure 1.** The positive relationship between study duration (hours) and tasks completed from all study sessions is represented in a scatter-plot (most recent observation: March 4, 2026). Each green point represents a study session. There is a general tendency for more tasks to be completed during longer sessions, however, there is considerable spread in the data, particularly at shorter duration.
